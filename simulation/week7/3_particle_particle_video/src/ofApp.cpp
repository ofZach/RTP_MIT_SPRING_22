...
void ofApp::update(){
	...
	if (bNewFrame){
		...
		#ifdef _USE_LIVE_VIDEO
				colorImg.setFromPixels(vidGrabber.getPixels().getData(), vidGrabber.getWidth(),vidGrabber.getHeight());
				colorImg.mirror(false, true);
		#else
				colorImg.setFromPixels(vidPlayer.getPixels().getData(), vidPlayer.getWidth(),vidPlayer.getHeight());
		#endif
